 ...
 */
static inline struct pi_cluster_task *pi_cluster_task(struct pi_cluster_task *task,
...
static inline int pi_cluster_send_task_async(struct pi_device *device,
					     struct pi_cluster_task *cluster_task, pi_task_t *task);
...
int pi_cluster_send_task_to_cl_async(struct pi_device *device, struct pi_cluster_task *cluster_task,
				     pi_task_t *task);
int pi_cluster_send_tasklet_to_cl_async(struct pi_device *device,
					struct pi_cluster_task *cluster_task, pi_task_t *task);

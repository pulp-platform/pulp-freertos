...
static inline uint32_t timer_cfg_lo_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_CFG_LO_OFFSET)); }
static inline void timer_cfg_lo_set(uint32_t base, uint32_t value) { writew(value, (uintptr_t) (base + TIMER_CFG_LO_OFFSET)); }

static inline uint32_t timer_cfg_hi_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_CFG_HI_OFFSET)); }
static inline void timer_cfg_hi_set(uint32_t base, uint32_t value) { writew(value,  (uintptr_t) (base + TIMER_CFG_HI_OFFSET)); }

static inline uint32_t timer_cnt_lo_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_CNT_LO_OFFSET)); }
static inline void timer_cnt_lo_set(uint32_t base, uint32_t value) { writew(value, (uintptr_t) (base + TIMER_CNT_LO_OFFSET)); }

static inline uint32_t timer_cnt_hi_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_CNT_HI_OFFSET)); }
static inline void timer_cnt_hi_set(uint32_t base, uint32_t value) { writew(value, (uintptr_t) (base + TIMER_CNT_HI_OFFSET)); }

static inline uint32_t timer_cmp_lo_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_CMP_LO_OFFSET)); }
static inline void timer_cmp_lo_set(uint32_t base, uint32_t value) { writew(value, (uintptr_t) (base + TIMER_CMP_LO_OFFSET)); }

static inline uint32_t timer_cmp_hi_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_CMP_HI_OFFSET)); }
static inline void timer_cmp_hi_set(uint32_t base, uint32_t value) { writew(value,  (uintptr_t) (base + TIMER_CMP_HI_OFFSET)); }

static inline uint32_t timer_start_lo_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_START_LO_OFFSET)); }
static inline void timer_start_lo_set(uint32_t base, uint32_t value) { writew(value, (uintptr_t) (base + TIMER_START_LO_OFFSET)); }

static inline uint32_t timer_start_hi_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_START_HI_OFFSET)); }
static inline void timer_start_hi_set(uint32_t base, uint32_t value) { writew(value, (uintptr_t) (base + TIMER_START_HI_OFFSET)); }

static inline uint32_t timer_reset_lo_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_RESET_LO_OFFSET)); }
static inline void timer_reset_lo_set(uint32_t base, uint32_t value) { writew(value, (uintptr_t) ( base + TIMER_RESET_LO_OFFSET)); }

static inline uint32_t timer_reset_hi_get(uint32_t base) { return readw((uintptr_t) (base + TIMER_RESET_HI_OFFSET)); }
static inline void timer_reset_hi_set(uint32_t base, uint32_t value) { writew(value, (uintptr_t) (base + TIMER_RESET_HI_OFFSET)); }

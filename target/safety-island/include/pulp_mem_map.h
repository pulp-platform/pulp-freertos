...
#ifdef CONFIG_CLIC
#define PULP_CLIC_OFFSET         0x00100000
#define PULP_EVENT_TO_INT_OFFSET 0x00009000
#endif
...
#define PULP_DEBUG_ADDR    (PULP_SOC_PERIPHERALS_ADDR + PULP_DEBUG_OFFSET)
#ifdef CONFIG_CLIC
#define PULP_CLIC_ADDR     (PULP_SOC_PERIPHERALS_ADDR + PULP_CLIC_OFFSET)
#define PULP_EVENT_TO_INT_ADDR (PULP_SOC_PERIPHERALS_ADDR + PULP_EVENT_TO_INT_OFFSET)
#endif

...
#define ARCHI_IDMA_EXT_ADDR                                                    \
        (ARCHI_CLUSTER_PERIPHERALS_ADDR + ARCHI_IDMA_EXT_OFFSET)
...
#define ARCHI_IDMA_DEMUX_ADDR                                                  \
        (ARCHI_DEMUX_PERIPHERALS_ADDR + ARCHI_IDMA_DEMUX_OFFSET)

/* SoC peripherals */
#define SOC_PERIPHERALS_ADDR (0x1A100000)

#define CLKDIV_OFFSET	    (0x00000000) /* replaces the FLL */
...
#ifdef CONFIG_CLIC
#define CLIC_OFFSET         0x00100000
#define EVENT_TO_INT_OFFSET 0x00009000
#endif

#define CLKDIV_ADDR	  (SOC_PERIPHERALS_ADDR + CLKDIV_OFFSET)
...
#ifdef CONFIG_CLIC
#define CLIC_ADDR     (SOC_PERIPHERALS_ADDR + CLIC_OFFSET)
#define EVENT_TO_INT_ADDR (SOC_PERIPHERALS_ADDR + EVENT_TO_INT_OFFSET)
#endif
